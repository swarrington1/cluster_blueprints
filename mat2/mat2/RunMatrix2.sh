...
if [ "$5" == "" ];then
    ...
    echo "usage: $0 <StudyFolder> <Subject> <DistanceThreshold> <DownsampleMat2Target> <Subset_seeds>"
...
ResultsFolder="${DiffStudyFolder_out}/${Subject}/Matrix2"
...
BedpostxFolder="${DiffStudyFolder}/${Subject}/dMRI/dMRI.bedpostX"
